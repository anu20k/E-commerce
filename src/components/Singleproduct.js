...
export default function Singleproduct({addToCart}) {
  ...
  const data = Mensdata.find((item) => item.title === title)
      ...
      <Container>
        <Row className="py-2">
          <Col className="text-center py-5 ">
            <img
              src={data.img1}
              className="border border-1  rounded-3 shadow-lg mt-5"
            />
          </Col>
          <Col className="py-5 ">
            <h1>{data.title}</h1>
            ...
            <span className="text-decoration-line-through fs-6 me-3">
              {data.mrp}
            </span>
            <span className="fw-bold fs-5 textpink">({data.offer} OFF)</span>
            <h6 className="text-success">inclusive of all taxes</h6>
            <h6 className="fw-bold lh-lg mb-4">SELECT SIZE</h6>
            <div className="mt-4 mb-4 gap-3">
              <span
                className="p-3 mx-2 border border-2 rounded-circle lh-lg border-danger  sizeeffect"
                
              >
                S
              </span>
              <span className="p-3 border border-2 rounded-circle lh-lg me-2 border-danger  sizeeffect">
                M
              </span>
              <span className="p-3 border border-2 rounded-circle lh-lg me-2 border-danger sizeeffect">
                L
            ...
            <p className="lh-base">
              ...
              <b>Sizes :</b> <br></br>S (Bust Size : 37 in, Length Size: 48 in)
              <br></br>M (Bust Size : 38 in, Length Size: 48 in)<br></br>L (Bust
              Size : 40 in, Length Size: 48 in)<br></br>
